...
exports.container.use(tokens_1.TOKENS.categoriesController).from(categories_module_1.CategoriesModule);
exports.container.use(tokens_1.TOKENS.brandsController).from(brands_module_1.BrandsModule);
// Core dependencies
...
(0, brandi_1.injected)(app_1.App, tokens_1.TOKENS.loggerService, tokens_1.TOKENS.configService, tokens_1.TOKENS.exceptionFilter, tokens_1.TOKENS.databaseService, tokens_1.TOKENS.authController, tokens_1.TOKENS.categoriesController, tokens_1.TOKENS.brandsController);
